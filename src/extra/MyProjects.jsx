...
export default function MyProjects() {
  return (
    <section className="bg-zinc-900 to-zinc-900 text-white py-16 px-24">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mt-10 max-w-6xl mx-auto">
        {features.map((feature, index) => (
          <div 
            key={index} 
            className="bg-zinc-800 p-6 rounded-lg shadow-lg flex flex-col items-start text-left w-full h-full transition-transform transform hover:scale-105 hover:bg-zinc-700 hover:shadow-xl"
          >
